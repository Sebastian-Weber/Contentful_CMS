                ...
                <div id="top-menu-box-title" className="px-4 mx-2 my-4 text-slate-300">Tags</div>
                    <ul className="flex flex-row items-center">
                        ...
                        <li className="my-1 px-2">
                          <div className="py-3 px-4 gap-2 font-semibold text-sm rounded-full text-slate-300 dark:text-gray-400 bg-slate-600">
                            <a href="" className=" text-slate-200 ">Entertainment</a>
                           </div>
                        </li>

                        <li className="my-1 px-2">
                          <div className="py-3 px-4 gap-2 font-semibold text-sm rounded-full text-slate-300 dark:text-gray-400 bg-purple-200">
                            <a href="" className=" text-purple-900">Data</a>
                           </div>
                        </li>
